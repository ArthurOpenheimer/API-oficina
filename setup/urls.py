...
from oficina.views import ClienteViewSet, FuncionarioViewSet, ServicoViewSet, VeiculoViewSet, ListaVeiculosClientes, ServicosRealizados, ServicosRealizadosPorVeiculo, ValorTotalServicosRealizados
...
urlpatterns = [
    ...
    path('veiculo/<int:pk>/servicos/valor/', ValorTotalServicosRealizados.as_view()),
]
